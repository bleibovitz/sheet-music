...
right = \relative c'' {
  ...
  r4 \tuplet 3/2 { <d d'>8^\markup { \box "Trumpet" } <d d'> <d d'> } <d d'>2 r4 \tuplet 3/2 { <d d'>8 <d d'> <d d'> } <d d'>2 R1*6
...
left = \relative c' {
  ...
  R1*2 <a d' e>2^\markup { \box "Trombones" \italic "(sounding 8va)" } <a cis' e> << { <e'' fis>1 } \\ { cis,,2_"C#" c2_"C" } >> << { g'''4 d } \\ { <g,, b'>2 } >> <g' a cis> <fis d'>4 << { <cis e'> <d fis'> < g, g''> d''2 cis4 } \\ { a2 b4 <a, e'>2. } >> <a g' d'>4 <b fis' d'>1
